...
/**
 * @file Circle.java
 * @brief Class to facilitate instantiation of a circle defined by its radius
 *        and centre specified in latitude and longitude
...
public class Circle {
	 ...
	 * 
	 * @param lat
	 *            the centre of the circle's latitude coordinate
	 * @param lng
	 *            the centre of the circle's longitude coordinate
	 * @param radius
